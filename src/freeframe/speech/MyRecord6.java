...
public class MyRecord6 extends JFrame implements MouseListener{
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if(e.getSource().equals(captureBtn))
        {
            ...
            String result = SpeechUtil.SpeechRecognition(path,SpeechUtil.FORMAT,SpeechUtil.RATE);
            System.out.println(result);
//            String result = SpeechUtil.SpeechRecognitionForBytes(audioData,SpeechUtil.FORMAT,SpeechUtil.RATE);
